...
def _get_info_color(percentage_of_beer: float, new_beer_state: bool, last_seen: datetime, time_stamp: datetime,
                    min_time_diff: int, tolerance: int, min_weight: int):
...
def get_info(min_time_diff: int, min_weight: int, max_weight: int, time_stamp: str, value: int, last_seen: str,
             tolerance: int, name: str, serial: str) -> INFO:
    ...
    info_color = _get_info_color(percentage_of_beer, new_beer_state, last_seen, time_stamp, min_time_diff, tolerance,
                                 min_weight)
